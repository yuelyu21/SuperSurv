...
```{r plot-standalone, fig.align='center', eval=requireNamespace("randomForestSRC", quietly = TRUE)}
...
```{r eval-standalone, fig.align='center', fig.height=4, fig.width= 9, eval=requireNamespace("randomForestSRC", quietly = TRUE)}
...
```{r plot-ensemble-benchmark, fig.align='center', fig.height=9, eval=requireNamespace("randomForestSRC", quietly = TRUE)}
plot_benchmark(
