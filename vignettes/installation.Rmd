---
title: "00. Installation & Setup"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{00. Installation & Setup}
...
* `surv.deepsurv` and `surv.deephit`: Require the R packages
  `survivalmodels` and `reticulate`, plus importable Python modules `torch`,
  `torchtuples`, and `pycox`. SuperSurv does not install or modify Python
