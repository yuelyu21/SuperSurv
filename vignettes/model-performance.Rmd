---
title: "02. Model Performance & Benchmarking"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{02. Model Performance & Benchmarking}
...
```{r plot-benchmark, fig.align='center', fig.width=9, fig.height=3, eval=has_ggplot2}
plot_benchmark(
  object = fit_supersurv,
  newdata = X_te,
  time = test$duration,
...
```{r plot-calibration, fig.align='center', eval=has_ggplot2}
