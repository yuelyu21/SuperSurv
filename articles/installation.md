...
and survival analysis. The framework integrates modern ensemble learning
techniques for right-censored data and is motivated by recent advances
in machine learning-based survival curve estimation (Westling et al.,
